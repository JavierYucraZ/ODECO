                  ...
                  (f = function (t, n, e) {
                    try {
                      ...
                      var m = new Date(),
                        ...
                        p = d || 0;
                      return e
                        ? new Date(Date.UTC($, M, D, y, g, v, p))
                        : new Date($, M, D, y, g, v, p);
                    } catch (t) {
                      return new Date("");
                    }
                  }),
              ...
              if (n)
                switch (n) {
                  case "ISO_8601":
                    ...
                    break;
                  case "RFC_2822":
                    e = dayjs_min(t, "ddd, MM MMM YYYY HH:mm:ss ZZ").format(
                      "YYYYMMDD"
                    );
                    break;
                  case "MYSQL":
        ...
        function (require, module, exports) {
          ...
          class Columns {
            ...
            order(t) {
              ...
              t.forEach((t, a) => {
                (n = o.headings[t]),
                  (l = "false" !== n.getAttribute("data-sortable")),
                  ((e = n.cloneNode(!0)).originalCellIndex = a),
                  (e.sortable = l),
                  h[0].push(e),
                  o.hiddenColumns.includes(t) ||
                    (((s = n.cloneNode(!0)).originalCellIndex = a),
                    (s.sortable = l),
                    h[1].push(s));
              }),
                o.data.forEach((e, s) => {
                  (a = e.cloneNode(!1)),
                    ...
                    t.forEach((t) => {
                      ((r = e.cells[t].cloneNode(!0)).data = e.cells[t].data),
                        a.appendChild(r),
                        o.hiddenColumns.includes(t) ||
                          (((r = e.cells[t].cloneNode(!0)).data =
                            e.cells[t].data),
                          i.appendChild(r));
                    }),
                    h[2].push(a),
            ...
            show(t) {
              if (t.length) {
                ...
                const s = this.dt;
                t.forEach((t) => {
                  (e = s.hiddenColumns.indexOf(t)) > -1 &&
                    s.hiddenColumns.splice(e, 1);
                }),
                  this.rebuild();
              }
            }
              ...
              this.dt.hiddenHeader
                ...
                this.dt.data.forEach((s, a) => {
                  t.data[a] &&
                    ...
                    (e.data = e.innerHTML),
                    t.render &&
                      (e.innerHTML = t.render.call(this, e.data, e, s)),
                    s.appendChild(e));
                }),
            ...
            sort(t, e, s) {
              ...
              const i =
                a.options.filters &&
                a.options.filters[a.headings[t].textContent];
              ...
              if ("date" === d.getAttribute("data-type")) {
                let t = !1;
                d.hasAttribute("data-format") &&
                  (t = d.getAttribute("data-format")),
                  c.push(
              ...
              Promise.all(c).then((i) => {
                ...
                Array.from(n).forEach((e) => {
                  ...
                  (i = c
                    ...
                    : a),
                    parseFloat(i) == i
                      ? (r[o++] = { value: Number(i), row: e })
                      : (l[h++] = {
                          value: "string" == typeof a ? a.toLowerCase() : a,
                          row: e,
                        });
                }),
                  e || (e = d.classList.contains("asc") ? "desc" : "asc"),
                  "desc" == e
                    ? ((p = sortItems(l, -1)),
                      (u = sortItems(r, -1)),
                      d.classList.remove("asc"),
                      d.classList.add("desc"))
                    : ((p = sortItems(r, 1)),
                      (u = sortItems(l, 1)),
                      d.classList.remove("desc"),
                      d.classList.add("asc")),
                  a.lastTh &&
                    d != a.lastTh &&
            ...
            rebuild() {
              ...
              (i.activeRows = []),
                ...
                i.data.forEach((l, r) => {
                  (t = l.cloneNode(!1)),
                    (e = l.cloneNode(!1)),
                    (t.dataIndex = e.dataIndex = r),
                    null !== l.searchIndex &&
                      void 0 !== l.searchIndex &&
                      (t.searchIndex = e.searchIndex = l.searchIndex),
                    Array.from(l.cells).forEach((n) => {
                      ((s = n.cloneNode(!0)).data = n.data),
                        t.appendChild(s),
                        i.hiddenColumns.includes(s.cellIndex) ||
                          (((a = s.cloneNode(!0)).data = s.data),
                          e.appendChild(a));
                    }),
                    n.push(t),
                    i.activeRows.push(e);
          ...
          const dataToTable = function (t) {
            ...
            defaultConfig = {
              ...
              labels: {
                ...
                perPage: "{select}",
                noRows: "No existen registros con los criterios de búsqueda",
          ...
          class DataTable {
            ...
            render(t) {
              ...
              if ((e.data && dataToTable.call(this), e.ajax)) {
                const t = e.ajax,
                  ...
                  i = (e) => {
                    if (4 === s.readyState)
                      if (
                        (this.emit("datatable.ajax.loaded", e, s),
                        200 === s.status)
                      ) {
                        const a = {};
                        (a.data = t.load
                          ...
                          t.content &&
                            t.content.type &&
                            ((a.type = t.content.type),
                            Object.assign(a, t.content)),
                          this.import(a),
                          this.setColumns(!0),
                          this.emit("datatable.ajax.success", e, s);
                ...
                s.addEventListener("progress", a, !1),
                  s.addEventListener("load", i, !1),
                  s.addEventListener("error", n, !1),
                  s.addEventListener("abort", l, !1),
                  this.emit("datatable.ajax.loading", s),
                  s.open("GET", "string" == typeof t ? e.ajax : e.ajax.url),
                  s.send();
              }
              if (
              ...
              if (
                ...
                e.header ||
                  (this.head && this.table.removeChild(this.table.tHead)),
                e.footer
                  ? this.head &&
                    !this.foot &&
                ...
                (t += e.labels.perPage),
                  (t += "<label>Registros por pagina</label></div>");
              ...
              const a = createElement("ul", {
                  class:
                    "pagination pagination-primary float-end dataTable-pagination",
                }),
                i = createElement("ul");
              a.appendChild(i),
            ...
            renderPage() {
              ...
              if (
                (this.totalPages &&
                  ((a =
                    (s = (e = this.currentPage - 1) * this.options.perPage) +
                    this.pages[e].length),
                  (s += 1),
                  (t = this.searching
            ...
            renderPager() {
              if ((flush(this.pagers), this.totalPages > 1)) {
                ...
                this.options.firstLast &&
                  e.appendChild(button(t, 1, this.options.firstText)),
                  this.options.nextPrev &&
                    e.appendChild(button(t, s, this.options.prevText));
                let i = this.links;
                this.options.truncatePager &&
                  ...
                  this.links[this.currentPage - 1].classList.add("active"),
                  this.options.nextPrev &&
                    e.appendChild(button(t, a, this.options.nextText)),
                  this.options.firstLast &&
                    e.appendChild(
                      button(t, this.totalPages, this.options.lastText)
                    ),
                ...
                this.headings &&
                  ...
                  this.headings.forEach((t, e) => {
                    if (
                      ...
                      (t.sortable =
                        "false" !== t.getAttribute("data-sortable")),
                      (t.originalCellIndex = e),
                  ...
                  (e) => {
                    ...
                    "a" === s.nodeName.toLowerCase() &&
                      (s.hasAttribute("data-page")
                        ? (this.page(s.getAttribute("data-page")),
                          e.preventDefault())
                        : t.sortable &&
                          s.classList.contains("dataTable-sorter") &&
                          "false" !=
                            s.parentNode.getAttribute("data-sortable") &&
                          (this.columns().sort(
                            this.headings.indexOf(s.parentNode)
                          ),
                          e.preventDefault()));
                  },
                  !1
                ...
                if (((this.columnWidths = []), this.table.tHead)) {
                  if (
                    (this.options.scrollY.length &&
                      ((e = createElement("thead")).appendChild(
                        createElement("tr")
                      ),
                      (e.style.height = "0px"),
                      this.headerTable &&
                    ...
                    this.data.forEach((e, s) => {
                      ...
                      t.split(" ").reduce((t, s) => {
                        ...
                        for (let t = 0; t < e.cells.length; t++)
                          if (
                            (n = (i = e.cells[t]).hasAttribute("data-content")
            ...
            export(t) {
              ...
              if (h.type) {
                if (
                  (("txt" !== h.type && "csv" !== h.type) ||
                    (s[0] = this.header),
                  h.selection)
                )
                  if (isNaN(h.selection)) {
                    if (Array.isArray(h.selection))
                      for (i = 0; i < h.selection.length; i++)
                        s = s.concat(this.pages[h.selection[i] - 1]);
                  ...
                  if ("txt" === h.type || "csv" === h.type) {
                    for (l = "", i = 0; i < s.length; i++) {
                      for (n = 0; n < s[i].cells.length; n++)
                        if (
                          !h.skipColumn.includes(e[n].originalCellIndex) &&
                          this.columns(e[n].originalCellIndex).visible()
                        ) {
                          let t = s[i].cells[n].textContent;
                          (t = (t = (t = (t = (t = t.trim()).replace(
                            /\s{2,}/g,
                            " "
                          )).replace(/\n/g, "  ")).replace(/"/g, '""')).replace(
                            /#/g,
                            ...
                            (l += t + h.columnDelimiter);
                        }
                      (l = l.trim().substring(0, l.length - 1)),
                        (l += h.lineDelimiter);
                    }
                    (l = l.trim().substring(0, l.length - 1)),
                      h.download && (l = `data:text/csv;charset=utf-8,${l}`);
                  } else if ("sql" === h.type) {
                    for (
                      l = `INSERT INTO \`${h.tableName}\` (`, i = 0;
                      i < e.length;
                      i++
                    )
                      !h.skipColumn.includes(e[i].originalCellIndex) &&
                    ...
                    for (
                      ...
                      for (l += "(", n = 0; n < s[i].cells.length; n++)
                        !h.skipColumn.includes(e[n].originalCellIndex) &&
                          this.columns(e[n].originalCellIndex).visible() &&
                          (l += `"${s[i].cells[n].textContent}",`);
                      (l = l.trim().substring(0, l.length - 1)), (l += "),");
                    }
                    (l = l.trim().substring(0, l.length - 1)),
                      (l += ";"),
                      h.download &&
                        (l = `data:application/sql;charset=utf-8,${l}`);
                  } else if ("json" === h.type) {
                    for (n = 0; n < s.length; n++)
                      for (a[n] = a[n] || {}, i = 0; i < e.length; i++)
                        !h.skipColumn.includes(e[i].originalCellIndex) &&
                          this.columns(e[i].originalCellIndex).visible() &&
                          (a[n][e[i].textContent] = s[n].cells[i].textContent);
                    (l = JSON.stringify(a, h.replacer, h.space)),
                      h.download &&
                        (l = `data:application/json;charset=utf-8,${l}`);
                  }
                  return (
                    h.download &&
                      ((h.filename = h.filename || "datatable_export"),
                      (h.filename += `.${h.type}`),
                      (l = encodeURI(l)),
                      ((r = document.createElement("a")).href = l),
                      (r.download = h.filename),
